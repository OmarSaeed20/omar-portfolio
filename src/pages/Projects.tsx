...
import { Github, ArrowUpRight, ExternalLink, Smartphone, Globe, FlaskConical, Boxes } from "lucide-react";
    ...
    <section id="projects" className="w-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-32 pb-24 min-h-screen text-foreground relative z-10 scroll-mt-32">
      ...
      >
        <div className="flex flex-col items-center mb-12 text-center">
          ...
          >
            Not a list of technologies — the problem, the ownership, the engineering decisions, and what survived production.
          </motion.p>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-6">
            <Boxes size={18} className="text-[var(--text-muted)]" />
            <h3 className="text-sm font-black uppercase tracking-widest text-[var(--text-muted)]">
              More Shipped Products
            </h3>
          </div>
